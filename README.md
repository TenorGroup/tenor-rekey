...
work in progress. read / decode / write / apdu are verified on real hardware;
the app shell (unified workspace, themes, i18n, live decode) works. clone UI,
key-dictionary settings, packaging, and the nested / MFKey32 live key-recovery
are on the roadmap. some dev paths are still hardcoded (being removed).
